...
<footer className="lg:w-10/12 md:w-10/12 sm:w-full mx-auto p-4 text-white bg-slate-700  sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between text-white">
        <div className="mb-6 md:mb-0">
            ...
            <img src="https://static.vecteezy.com/system/resources/previews/002/986/080/original/letter-g-logo-design-template-free-vector.jpg"  className="h-6 mr-3 sm:h-9 rounded-full" alt="Getbone Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Getbone</span>
            </a>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul className="">
                    <li className="mb-4">
                        <a href="https://flowbite.com/" className="hover:underline">Getbone</a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul className=" ">
                    <li className="mb-4">
                        <a href="https://github.com/Joy5k" className="hover:underline ">Github</a>
                    </li>
                    <li>
