...
<aside className="w-64  " aria-label="Sidebar">
   <div className=" overflow-y-auto py-4 px-3 bg-gray-50 rounded  sm:px-4 sticky top-0 z-50 ">
      <ul className="space-y-2 ">
         <li className=''>
            <a href="#" className="flex items-center p-2 font-normal text-gray-900 rounded-lg hover:text-white  hover:bg-blue-500">
        ...
        <FaLaptop></FaLaptop>
         ...
         <li>
           ...
           <p className='text-5xl font-bold text-center'>Hello world</p>
</aside>
